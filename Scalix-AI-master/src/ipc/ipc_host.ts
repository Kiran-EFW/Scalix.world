...
import { registerStripeHandlers } from "./handlers/stripe_handlers";
import { registerRazorpayHandlers } from "./handlers/razorpay_handlers";
import { registerAwsS3Handlers } from "./handlers/aws_s3_handlers";
import { registerCloudflareR2Handlers } from "./handlers/cloudflare_r2_handlers";
import { registerSendGridHandlers } from "./handlers/sendgrid_handlers";
import { registerResendHandlers } from "./handlers/resend_handlers";
import { registerMixpanelHandlers } from "./handlers/mixpanel_handlers";
import { registerSentryHandlers } from "./handlers/sentry_handlers";
...
export function registerIpcHandlers() {
  ...
  registerRazorpayHandlers();
  registerAwsS3Handlers();
  registerCloudflareR2Handlers();
  registerSendGridHandlers();
  registerResendHandlers();
  registerMixpanelHandlers();
